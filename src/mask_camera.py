...
def signature_msg(frame):
    cv2.putText(frame, 'Predator', (100, 470), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (50, 50, 50), 1, cv2.LINE_AA)
    return frame
...
def thermal_msg(frame, pixels):
    ...
    if temp == 0:
        ...
        cv2.putText(frame, 'No thermal sensor ', (120, 42), cv2.FONT_HERSHEY_TRIPLEX, 0.7, (255, 255, 255), 1, cv2.LINE_AA)                
...
def identify_maskman(device_num, delay=1, window_name='Predator'):
